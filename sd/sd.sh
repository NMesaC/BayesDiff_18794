...
--ckpt "./checkpoints/v1-5-pruned-emaonly.ckpt" --local_image_path "../image_from_url" \
--laion_art_path "./laion_art" --H 512 --W 512 --scale 3 --train_la_data_size 1000 \
--train_la_batch_size 10 --sample_batch_size 2 --total_n_samples 48 --timesteps 50

# # Cooperate UQ into dpm-solver-2 sampler, experiment results will be saved in ./dpm_solver_2_exp/skipUQ/
# CUDA_VISIBLE_DEVICES=1 python dpmsolver_skipUQ.py --prompt "your_prompt" \
